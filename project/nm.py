...
def is_house(x, y):
    box_houses = [(69, 111), (69, 264), (138, 12), (138, 165), (192, 111), (192, 264), (261, 12), (261, 165)]
    bottom_corner_houses = [(69, 12), (69, 165), (192, 12), (192, 165)]
    top_corner_houses = [(138, 51), (138, 204), (261, 51), (261, 204)]
...
def function(epsilon=1e-10):
    ...
    for i in range(0, N):
        ...
        for j in range(0, 4):
            ...
            if not is_house(x1, y1) and x1 <= 299 and 0 < y1 <= 299:
                A[i, x1 * 300 + y1] += cf
            else:
                A[i, i] += cf
    ...
    for i in range(50000):
        new = A * ans + a
        if np.max(np.abs(new - ans) / max(1, len(ans))) < epsilon:
            break
        ans = new
    return ans
